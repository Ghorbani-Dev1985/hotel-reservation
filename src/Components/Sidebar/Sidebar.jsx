...
function Sidebar({ sidebarOpen, setSidebarOpen }) {
  ...
  return (
    <div>
      ...
      <div
        className={`fixed inset-0 bg-violet-800 bg-opacity-30 z-40 lg:hidden lg:z-auto transition-opacity duration-200 ${
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          {/* Logo */}
          <NavLink end to="/" className="w-full flex justify-center items-center">
          <FaHotel className='text-white text-6xl'/>
          </NavLink>
        </div>
